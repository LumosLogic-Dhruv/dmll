  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "blur-in": "blur-in 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "glow-pulse": "glow-pulse 3s ease-in-out infinite",
        "shimmer": "shimmer 2s linear infinite",
        "float": "float 3s ease-in-out infinite",
        "mega-menu-in": "mega-menu-in 0.2s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "mega-menu-out": "mega-menu-out 0.15s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
